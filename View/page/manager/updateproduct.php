    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <div class="description">
            <label for="description">
                <p>Mô tả sản phẩm*:</p>
                <textarea name="description" id="description" placeholder="<?php echo $dataProductId['descrip']; ?>" cols="69" rows="2"></textarea>
            </label>
        </div>
        <div class="image">
            <label for="image">
        ...
        <div class="price">
            <label for="price">
                <p>Giá*:</p>
                <input type="number" name="price" value="<?php echo $dataProductId['price']; ?>" id="price" required>
            </label>
        </div>
        <div class="category">
            <p>Loại công việc:</p>
